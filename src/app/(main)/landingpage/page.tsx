...
// Componente auxiliar para os itens de 'Serviços'
const ServiceItem = ({ title }) => (
  <li className="p-4 bg-white border-b-2 border-orange-600 rounded-lg shadow-sm hover:shadow-md transition duration-300 text-center">
...
const Card = ({ title, description }) => (
  <div className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition duration-300 border-t-4 border-orange-600">
    <h3 className="text-xl font-bold text-gray-900 mb-3">{title}</h3>
    <p className="text-gray-600">{description}</p>
  </div>
);

// Mantenho o nome da função como "land" conforme solicitado.
function land() {
  const currentYear = new Date().getFullYear();

  // URL de placeholder para replicar o elemento visual da imagem
  const heroImageUrl = "https://placehold.co/400x400/F97316/FFFFFF?text=Abelhas+%2B+Finan%C3%A7as";
    ...
    <div className="min-h-screen bg-white text-gray-800 font-sans">
      ...
      <header className="fixed top-0 left-0 w-full bg-white shadow-sm z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
          ...
          <div className="flex space-x-3">
            ...
            <Button href="#servicos" outline={true} className="hidden sm:inline-flex">
              ENTRAR
            </Button>
          </div>
        </div>
      ...
      <main className="pt-24 pb-12 sm:pt-32 sm:pb-24">
        <section id="hero" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight leading-tight text-gray-900 mb-6">
              A melhor forma de
            ...
            <p className="text-xl text-gray-600 mb-10 max-w-lg">
              ...
              Somos uma empresa dedicada a fornecer soluções inovadoras para as suas necessidades de educação financeira.
            </p>
            {/* Botão de Call to Action principal */}
            <Button href="#contato" className="text-lg py-3 px-8 shadow-xl">
              COMEÇAR
            </Button>
          </div>
          ...
          <div className="flex justify-center lg:justify-end">
            <img
              ...
              className="w-full max-w-sm lg:max-w-lg rounded-xl shadow-2xl"
        ...
        <section id="sobre" className="mt-24 py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl font-bold text-center text-gray-900 mb-4">Sobre Nós</h2>
            <p className="text-center text-lg text-gray-600 mb-12 max-w-3xl mx-auto">
              Somos uma empresa dedicada a fornecer soluções inovadoras para as suas necessidades.
        ...
        {/* 4. Seção 'Nossos Serviços' (Conteúdo original, mas estilizado) */}
        <section id="servicos" className="py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 list-none p-0">
              <ServiceItem title="Desenvolvimento Web" />
              <ServiceItem title="Design de Interface" />
              <ServiceItem title="Consultoria em Tecnologia" />
              <ServiceItem title="Marketing Digital" />
            </ul>
          </div>
        </section>

        {/* 5. Seção 'Entre em Contato' (Conteúdo original, estilizado como bloco de destaque) */}
        <section id="contato" className="py-20 bg-orange-600">
